...
import { AuthResponse } from '../../settings/api/auth.response';
                ...
                <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                    <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                        <div class="text-center mb-8">
                            ...
                            <span class="text-muted-color font-medium">Iniciar sessão</span>
                        </div>

                        <div>
                            <label for="email1" class="block text-surface-900 dark:text-surface-0 text-xl font-medium mb-2">Usuário</label>
                            <input pInputText id="email1" [(ngModel)]="username" type="text" placeholder="Entrar com usuário" class="w-full md:w-120 mb-8" />

                            <label for="password1" class="block text-surface-900 dark:text-surface-0 font-medium text-xl mb-2">Senha</label>
                            <p-password id="password1" [(ngModel)]="passwordHash" placeholder="Senha" [toggleMask]="true" styleClass="mb-4" [fluid]="true" [feedback]="false"></p-password>
                            ...
                            <div class="flex items-center justify-between mt-2 mb-8 gap-8">
                                ...
                                <span class="font-medium no-underline ml-2 text-right cursor-pointer text-primary">Esquecir minha senha?</span>
                                
                                
                            </div>
                            <p-button label="Iniciar sessão" styleClass="w-full" (click)="Login()"></p-button>
                        </div>
                    </div>
                </div>
            </div>
