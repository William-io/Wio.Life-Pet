...
@Component({
    ...
    template: `
        <div class="card">
            ...
            <p class="text-lg mb-4">Wio.Life Pet App is an application template for Angular and is distributed as a CLI project. Current versions is Angular v20 with PrimeNG v20. In case CLI is not installed already, use the command below to set it up.</p>
            <pre class="app-code">
